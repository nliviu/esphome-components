/*
 * ESPHome license https://github.com/esphome/esphome/blob/dev/LICENSE
 *
 * Modified ST7789V by Liviu Nicolescu for ST7789 240x240
 */
#pragma once
...
class ST7789
 ...
 protected:
  ...
  void draw_filled_rect_(uint16_t x1, uint16_t y1, uint16_t x2, uint16_t y2,
                         uint16_t color);
